...
create policy "options_update_private"
on public.options_positions for update
using (
  user_id = auth.uid()
  or auth.jwt() ->> 'email' = 'xxj8166@gmail.com'
)
...
create policy "options_delete_private"
