...
assert 'assets/roll-manager.js?v=3.3.0' in page and 'assets/roll-manager.css?v=3.3.0' in page
...
assert "clearBudget" in budget_js and "deleteTarget" in generator
